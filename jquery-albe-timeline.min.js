...
(function($) {
    $.fn.albeTimeline = function(json, options) {
        ...
        $.each(json, function(index, element) {
            ...
            $.each(element.body, function(index2, value2) {
                var e = $("<" + value2.tag + ">");
                if (value2.tag = 'p') {
                    e.addClass("comentario");
                }
                $(value2.attr).each(function() {
                    $.each(this, function(index3, value3) {
                        index3.toLowerCase() === "cssclass" ?
                            e.addClass(value3) :
                            e.attr(index3, value3);
                    });
                });
            ...
            var slot = $(
                '<article id="a' + ano + "-" + (irmaos.length + 1) + '">'
            ).append(ePanel);
    ...
    var fnDateFormat = function(value, format, language) {
        ...
        format = format.replace(
            "MMM",
            language.months[newDate.getMonth()].substring(0, 3)
        );
